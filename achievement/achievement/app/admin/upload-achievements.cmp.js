...
var UploadAchievementsComponent = (function () {
    ...
    UploadAchievementsComponent = __decorate([
        core_1.Component({
            selector: 'my-upload-achievements',
            templateUrl: 'app/admin/upload-achievements.cmp.html'
        }), 
        __metadata('design:paramtypes', [])
    ], UploadAchievementsComponent);
    return UploadAchievementsComponent;
}());
exports.UploadAchievementsComponent = UploadAchievementsComponent;
//# sourceMappingURL=upload-achievements.cmp.js.map